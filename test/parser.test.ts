...
//        const query = new Parser(new Lexer(input)).parse();
//        expect(query.plotClause).toEqual({
//            plotFunction: "BAR",
//            categoriesColumn: "xcol",
//            valuesColumn: "ycol"
//        });
//    });
//
...
//        expect(statement.plotClause!.plotFunction).toBe("BAR");
...
//        const statement = new Parser(new Lexer(input)).parse();
//        expect(statement.plotClause!.plotFunction).toBe("SCATTER");
//        expect(Array.from(statement.plotCall.args.values())).toEqual([
//            { column: "xcol" },
